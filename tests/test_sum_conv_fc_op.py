...
class SumConvFCOpTest(unittest.TestCase):

    def _run_sum_conv_fc_op_gpu(self, X1, X2):
        with core.DeviceScope(core.DeviceOption(caffe2_pb2.CUDA, 0)):
            op = core.CreateOperator('SumConvFC', ['X1', 'X2'], ['Y'])
    ...
    def test_res(self):
        ...
        Y_act = self._run_sum_conv_fc_op_gpu(X1, X2)
...
if __name__ == '__main__':
    ...
    assert 'SumConvFC' in workspace.RegisteredOperators()
    unittest.main()
