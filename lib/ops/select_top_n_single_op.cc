...
template <>
bool SelectTopNSingleOp<float, CPUContext>::RunOnDevice() {
...
REGISTER_CPU_OPERATOR(SelectTopNSingle, SelectTopNSingleOp<float, CPUContext>);

OPERATOR_SCHEMA(SelectTopNSingle)
    .NumInputs(1)
    .NumOutputs(2)
    .SetDoc(R"DOC(
