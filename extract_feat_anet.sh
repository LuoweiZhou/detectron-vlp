...
# python tools/extract_features_vg_anet_xinlei.py --output-dir /checkpoint02/luoweizhou/dat/anet/fc6_feat_100dets --det-output-file /checkpoint02/luoweizhou/dat/anet/anet_detection_vg_fc6_feat_100dets"$1".h5 --max_bboxes 100 --min_bboxes 100 --list_of_ids $list_of_ids /checkpoint02/luoweizhou/dat/anet/frames_10frm | tee log/log_extract_features_vg_100dets_$split_file

python tools/extract_features_vg_anet_xinlei.py --output-dir /checkpoint02/luoweizhou/dat/anet/fc6_feat_100dets_nms_0.5 --det-output-file /checkpoint02/luoweizhou/dat/anet/anet_detection_vg_fc6_feat_100dets-nms_0.5-"$1".h5 --max_bboxes 100 --min_bboxes 100 --list_of_ids $list_of_ids /checkpoint02/luoweizhou/dat/anet/frames_10frm --cfg /private/home/luoweizhou/subsystem/detectron-xinlei/configs/visual_genome_trainval/e2e_faster_rcnn_X-101-64x4d-FPN_2x-NMS_0.5.yaml | tee log/log_extract_features_vg_100dets_nms0.5_$split_file
